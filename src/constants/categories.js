...
export const CATEGORY_DATA = [
  ...
  },
  {
    ...
    icon: Video,
    subcategories: ['Video Montaj', '2D/3D Animasiya', 'İntro və Outro', 'Reklam Videoları', 'YouTube Videoları', 'Subtitr və Tərcümə', 'Vizual Effektlər (VFX)', 'AI ilə Hazırlanmış Qısa Metrajlı / Tam Videolar'],
  },
  {
